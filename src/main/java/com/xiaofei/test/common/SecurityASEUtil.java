...
public class SecurityASEUtil {
    ...
    public static void main(String[] args) {
        ...
        String encryptAES = "RTA2MjlDM0U4NjU4Q0M0MUFFQzgyREQxRTlFQ0E0MUY5REY0QkE3NTkxRjJFNjhDOTVBOEQ5ODZGRUE1RTJCOUQzREFGQ0Q4NjFGMzE4ODE3ODgxQUNDQzkzNjlBRUUw=====";
        String decrypt = SecurityASEUtil.decrypt(encryptAES);
